    ...
    decisions: [
      ...
      },
      {
        ...
        options: [
          ...
          { id: 'easiest-first', label: 'Начать с model cost: его проще всего точно посчитать.', grade: 'weak', feedback: 'Простота проверки не делает неизвестное приоритетным. Можно идеально измерить дешёвую ошибку и пропустить дорогую ставку.' },
