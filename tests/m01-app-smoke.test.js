...
test('fresh validation route renders baseline without exposing treatment or post-case controls', () => {
...
test('submitted baseline raw validation renderer exposes only the replaceable M01 learning placeholders', () => {
